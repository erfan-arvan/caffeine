...
final class AccessOrderDeque<E extends AccessOrder<E>> extends AbstractLinkedDeque<E> {
    ...
    @org.checkerframework.dataflow.qual.Pure
     @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull boolean contains(@org.checkerframework.checker.initialization.qual.UnknownInitialization(com.github.benmanes.caffeine.cache.Node.class) @org.checkerframework.checker.nullness.qual.NonNull AccessOrder<?> e) {
    ...
    // A fast-path removal
    @org.checkerframework.dataflow.qual.Impure
     @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull boolean remove(@org.checkerframework.checker.initialization.qual.UnknownInitialization(com.github.benmanes.caffeine.cache.Node.class) E e) {
        if (contains(e)) {
            unlink(e);
            return true;
        }
    ...
    public void setPrevious(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull AccessOrderDeque<E> this, E e, E prev) {
    ...
    @org.checkerframework.dataflow.qual.SideEffectFree
    public void setNext(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull AccessOrderDeque<E> this, E e, E next) {
