...
public final class Caffeine<K, V> {
    ...
    static final  @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull int DEFAULT_INITIAL_CAPACITY = 0;
    ...
    <K1 extends K, V1 extends V> @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull Weigher<K1, V1> getWeigher( @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull boolean isAsync) {
        Weigher<K1, V1> delegate = isWeighted() && (weigher != Weigher.singletonWeigher()) ? Weigher.boundedWeigher((Weigher<K1, V1>) weigher) : Weigher.singletonWeigher();
     ...
     */
    @org.checkerframework.dataflow.qual.Impure
    public <K1 extends K, V1 extends V> @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull Caffeine<K1, V1> writer(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.Nullable CacheWriter<? super K1, ? super V1> writer) {
    ...
    @org.checkerframework.dataflow.qual.Pure
    <K1 extends K, V1 extends V> @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.Nullable CacheWriter<K1, V1> getCacheWriter() {
    ...
    public <K1 extends K, V1 extends V> @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull Cache<K1, V1> build() {
        ...
        Caffeine<K1, V1> self = (Caffeine<K1, V1>) this;
        return isBounded() || refreshes() ? new BoundedLocalCache.BoundedLocalManualCache<>(self) : new UnboundedLocalCache.UnboundedLocalManualCache<>(self);
    }
