...
abstract class Node<K, V> implements AccessOrder<Node<K, V>>, WriteOrder<Node<K, V>> {
    ...
    public abstract void setValue(V value, @org.checkerframework.checker.initialization.qual.FBCBottom @org.checkerframework.checker.nullness.qual.Nullable ReferenceQueue<V> referenceQueue);
    ...
    @org.checkerframework.dataflow.qual.Pure
    public @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.Nullable Node<K, V> getPreviousInVariableOrder() {
        return null;
    }

    @org.checkerframework.dataflow.qual.Impure
    public void setPreviousInVariableOrder(@org.checkerframework.checker.initialization.qual.UnknownInitialization(java.lang.Object.class) @org.checkerframework.checker.nullness.qual.Nullable Node<K, V> prev) {
        throw new UnsupportedOperationException();
    }

    @org.checkerframework.dataflow.qual.Pure
    public @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.Nullable Node<K, V> getNextInVariableOrder() {
        return null;
    }

    @org.checkerframework.dataflow.qual.Impure
    public void setNextInVariableOrder(@org.checkerframework.checker.initialization.qual.UnknownInitialization(java.lang.Object.class) @org.checkerframework.checker.nullness.qual.Nullable Node<K, V> prev) {
        throw new UnsupportedOperationException();
    }
    ...
    @org.checkerframework.dataflow.qual.SideEffectFree
    public void setPreviousInAccessOrder(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull Node<K, V> this, @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull Node<K, V> prev) {
        throw new UnsupportedOperationException();
    }
    ...
    @org.checkerframework.dataflow.qual.SideEffectFree
    public void setNextInAccessOrder(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull Node<K, V> this, @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull Node<K, V> next) {
        throw new UnsupportedOperationException();
    }
    ...
    @org.checkerframework.dataflow.qual.SideEffectFree
    public void setPreviousInWriteOrder(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull Node<K, V> this, @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull Node<K, V> prev) {
        throw new UnsupportedOperationException();
    }
    ...
    @org.checkerframework.dataflow.qual.SideEffectFree
    public void setNextInWriteOrder(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull Node<K, V> this, @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull Node<K, V> next) {
        throw new UnsupportedOperationException();
    }
