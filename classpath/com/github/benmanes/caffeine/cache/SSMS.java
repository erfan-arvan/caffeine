...
class SSMS<K, V> extends SS<K, V> {
  protected static final long MAXIMUM_OFFSET = UnsafeAccess.objectFieldOffset(SSMS.class, com.github.benmanes.caffeine.cache.LocalCacheFactory.MAXIMUM);

  protected static final long EDEN_MAXIMUM_OFFSET = UnsafeAccess.objectFieldOffset(SSMS.class, com.github.benmanes.caffeine.cache.LocalCacheFactory.EDEN_MAXIMUM);

  protected static final long MAIN_PROTECTED_MAXIMUM_OFFSET = UnsafeAccess.objectFieldOffset(SSMS.class, com.github.benmanes.caffeine.cache.LocalCacheFactory.MAIN_PROTECTED_MAXIMUM);

  protected static final long WEIGHTED_SIZE_OFFSET = UnsafeAccess.objectFieldOffset(SSMS.class, com.github.benmanes.caffeine.cache.LocalCacheFactory.WEIGHTED_SIZE);

  protected static final long EDEN_WEIGHTED_SIZE_OFFSET = UnsafeAccess.objectFieldOffset(SSMS.class, com.github.benmanes.caffeine.cache.LocalCacheFactory.EDEN_WEIGHTED_SIZE);

  protected static final long MAIN_PROTECTED_WEIGHTED_SIZE_OFFSET = UnsafeAccess.objectFieldOffset(SSMS.class, com.github.benmanes.caffeine.cache.LocalCacheFactory.MAIN_PROTECTED_WEIGHTED_SIZE);
