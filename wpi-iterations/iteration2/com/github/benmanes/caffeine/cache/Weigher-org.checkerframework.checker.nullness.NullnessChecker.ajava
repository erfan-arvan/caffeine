...
public interface Weigher<K, V> {
     ...
     */
    @org.checkerframework.dataflow.qual.Pure
    static <K, V> @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull Weigher<K, V> boundedWeigher(Weigher<K, V> delegate) {
...
final class BoundedWeigher<K, V> implements Weigher<K, V>, Serializable {
    ...
    final @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull Weigher<? super K, ? super V> delegate;
    ...
    @org.checkerframework.dataflow.qual.Impure
    public  @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull int weigh(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull BoundedWeigher<K, V> this, K key, V value) {
