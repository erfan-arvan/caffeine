...
public interface Policy<K, V> {
    ...
    V> {
         ...
         */
        @org.checkerframework.dataflow.qual.Pure
        OptionalLong ageOf(K key, @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull TimeUnit unit);
        ...
        default @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull Optional<Duration> ageOf(K key) {
            // This method will be abstract in version 3.0.0
         ...
         */
        @org.checkerframework.dataflow.qual.Pure
        long getExpiresAfter(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull TimeUnit unit);
         ...
         */
        @org.checkerframework.dataflow.qual.Impure
        default @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull Duration getExpiresAfter() {
            // This method will be abstract in version 3.0.0
         ...
         */
        @org.checkerframework.dataflow.qual.SideEffectFree
        void setExpiresAfter( @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull long duration, @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull TimeUnit unit);
    ...
    interface VarExpiration<K, V> {
         ...
         */
        @org.checkerframework.dataflow.qual.Pure
        OptionalLong getExpiresAfter(K key, @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull TimeUnit unit);
         ...
         */
        @org.checkerframework.dataflow.qual.Impure
        default @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull Optional<Duration> getExpiresAfter(K key) {
            // This method will be abstract in version 3.0.0
         ...
         */
        @org.checkerframework.dataflow.qual.SideEffectFree
        void setExpiresAfter(K key,  @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull long duration, @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull TimeUnit unit);
         ...
         */
        @org.checkerframework.dataflow.qual.Pure
        default boolean putIfAbsent(K key, V value,  @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull long duration, @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull TimeUnit unit) {
         ...
         */
        @org.checkerframework.dataflow.qual.Impure
        default  @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull boolean putIfAbsent(K key, V value, Duration duration) {
            // This method will be abstract in version 3.0.0
         ...
         */
        @org.checkerframework.dataflow.qual.SideEffectFree
        default void put(K key, V value,  @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull long duration, @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull TimeUnit unit) {
            // This method was added & implemented in version 2.6.0
            throw new UnsupportedOperationException();
        }
