...
interface LinkedDeque<E> extends Deque<E> {
    ...
    interface PeekingIterator<E> extends Iterator<E> {
         ...
         */
        @org.checkerframework.dataflow.qual.Impure
        static <E> @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull PeekingIterator<E> concat(PeekingIterator<E> first, PeekingIterator<E> second) {
         ...
         */
        @org.checkerframework.dataflow.qual.Impure
        static <E> @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull PeekingIterator<E> comparing(PeekingIterator<E> first, PeekingIterator<E> second, Comparator<E> comparator) {
            return new PeekingIterator<E>() {
