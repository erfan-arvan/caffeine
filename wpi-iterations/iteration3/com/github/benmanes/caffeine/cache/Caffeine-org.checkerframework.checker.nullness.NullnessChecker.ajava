...
public final class Caffeine<K, V> {
     ...
     */
    public Caffeine<K, V> maximumSize( @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull long maximumSize) {
     ...
     */
    public Caffeine<K, V> maximumWeight( @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull long maximumWeight) {
        requireState(this.maximumWeight == UNSET_INT, "maximum weight was already set to %s", this.maximumWeight);
        requireState(this.maximumSize == UNSET_INT, "maximum size was already set to %s", this.maximumSize);
     ...
     */
    public <K1 extends K, V1 extends V> Caffeine<K1, V1> weigher(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull Weigher<? super K1, ? super V1> weigher) {
    ...
    <K1 extends K, V1 extends V> Weigher<K1, V1> getWeigher( @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull boolean isAsync) {
     ...
     */
    public Caffeine<K, V> expireAfterWrite( @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull long duration, @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull TimeUnit unit) {
     ...
     */
    public Caffeine<K, V> expireAfterAccess( @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull long duration, @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull TimeUnit unit) {
     ...
     */
    public <K1 extends K, V1 extends V> Caffeine<K1, V1> expireAfter(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull Expiry<? super K1, ? super V1> expiry) {
     ...
     */
    public Caffeine<K, V> refreshAfterWrite( @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull long duration, @org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull TimeUnit unit) {
        requireNonNull(unit);
     ...
     */
    public Caffeine<K, V> ticker(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull Ticker ticker) {
     ...
     */
    public <K1 extends K, V1 extends V> Caffeine<K1, V1> removalListener(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull RemovalListener<? super K1, ? super V1> removalListener) {
     ...
     */
    public <K1 extends K, V1 extends V> Caffeine<K1, V1> writer(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull CacheWriter<? super K1, ? super V1> writer) {
     ...
     */
    public <K1 extends K, V1 extends V> LoadingCache<K1, V1> build(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull CacheLoader<? super K1, V1> loader) {
        requireWeightWithWeigher();
        Caffeine<K1, V1> self = (Caffeine<K1, V1>) this;
     ...
     * @throws NullPointerException if the specified cache loader is null
     */
    public <K1 extends K, V1 extends V> AsyncLoadingCache<K1, V1> buildAsync(@org.checkerframework.checker.initialization.qual.Initialized @org.checkerframework.checker.nullness.qual.NonNull AsyncCacheLoader<? super K1, V1> loader) {
